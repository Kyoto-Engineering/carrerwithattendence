...
$count=0;
	if($count == 0){
		$query = "UPDATE tbl_reference SET stat = '2' WHERE phone = '$user_contact'";
		...
		if ($result) {
							...
							$email_subject= "Reference Denial";
							$email_message= "
Dear $userName,
Sorry!!
Name : $rName
email : $email
phone : $user_contact
has Denied to be your Reference.
...
01844046677";
							...
							$email_subject1= "Reference Denial";
							$email_message1= "
Dear $userName,
Sorry!!
Name : $rName

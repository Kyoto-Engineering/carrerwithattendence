...
$uquery = "UPDATE step_07 SET jobstatus = '1' WHERE phone = '$user_contact'";
...
if ($res) {
		...
		?>
							...
							$email_subject= "You agreed for preselection";
							$email_message= "
Dear $name,
You agreed for the folowing position:
Job Title: $job
        ";
							...
							$email_subject1= "You agreed for preselection";
							$email_message1= "
Dear $name,

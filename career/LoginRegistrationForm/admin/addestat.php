...
?>
  ...
  <div class="content-wrapper">
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])){
      $attendence = $atten->insertestat($_POST, $date);
    }
?>
<div class="row">
...
?>
  <form action="" method="post" style="padding:2px">
    ...
    <label for="sel1">Add Employee Status:</label>
    <input type="text" name="estat" class="form-control"><br/>

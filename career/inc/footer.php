    ...
    <div class="row">
      <div class="footer-section">
          ...
          <div class="single-secton">
            ...
            <div class="form" method="post">
              <div class="form-group">
                <input placeholder="Enter your Email" name="email" id="exampleInputName1" class="form-control first" type="text">
              </div>
              <input class="bttn" value="Subscribe" name="submit">
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="single-secton">
           ...
           <center> <ul>
              <li class="facebook"><a href="https://www.facebook.com/KEAL.BD.Official/"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="col-sm-4">
          <div class="single-secton">
            <h3>Need Help ?</h3>
            <p><i class="fa fa-phone"></i> CALL US : <span>+88 01844046644</span></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6 col-md-4">
        <div class="single-section-two"> <img src="images/kyoto.png" alt="" height="auto" width="120px">
...
<!--         <div class="single-section-two white">
      ...
      <div class="col-sm-12 col-md-4">
        <div class="single-section-two">
          ...
          <div>
           <div class="text-center"> <a href="LoginRegistrationForm/feedback.php" class="btn-one">Give Your Feedback</a></div>
...
<div class="copyright-wrapper">
  <div class="container">
	...
	document.write(d.getFullYear());
      ...
      Kyoto Engineering & Automation Ltd.| All Rights Reserved.</p>
  </div>
</div>
<!-- Copyright styles End --> 
...
<!-- Mirrored from sbtechnosoft.com/recruitepro/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Jan 2018 03:38:36 GMT -->
</html>